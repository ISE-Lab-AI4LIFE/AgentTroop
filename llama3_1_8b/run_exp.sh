#!/usr/bin/env bash
# ===========================================================================
#  HARMONY-X — Llama-3.1-8B Full Experiment Pipeline
#
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        --help|-h)
            ...
            echo ""
            echo "Run the full HARMONY-X pipeline against Llama-3.1-8B."
            echo ""
            echo "Options:"
...
echo "  Target:   Llama-3.1-8B (via Ollama)"
...
if command -v ollama &>/dev/null; then
    ...
    echo "[OK]   Model llama3.1:8b available"
fi
