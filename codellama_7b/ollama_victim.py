"""Adapter for CodeLlama-7B running locally via Ollama."""
...
class OllamaVictim(BaseVictim):
    """Black-box victim wrapping CodeLlama-7B through the Ollama HTTP API.
    ...
    CodeLlama-7B may produce longer code outputs, so ``max_tokens`` is
    ...
    def _classify(self, text: str) -> bool:
        ...
        # to ASCII apostrophe (U+0027) — CodeLlama-7B may use the
