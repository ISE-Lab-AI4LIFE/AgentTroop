#!/usr/bin/env bash
# ===========================================================================
#  HARMONY-X — MeetAISmall Setup Script
...
echo "═══════════════════════════════════════════════════════════════"
echo "  HARMONY-X — MeetAISmall Environment Setup"
echo "  Target:   MeetSolanki/MeetAISmall:latest (via Ollama)"
...
# ── 3. Ollama + MeetAISmall model ──
echo ""
echo "── Step 3/5: Ollama + MeetSolanki/MeetAISmall:latest ──"
...
# Pull model
if ! ollama list 2>/dev/null | grep -q "MeetSolanki/MeetAISmall:latest"; then
    echo "[...] Pulling MeetSolanki/MeetAISmall:latest (this may take a while)..."
    ollama pull MeetSolanki/MeetAISmall:latest
fi
echo "[OK]   Model MeetSolanki/MeetAISmall:latest available"
